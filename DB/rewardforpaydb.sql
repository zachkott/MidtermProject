...
INSERT INTO `employee` (`id`, `first_name`, `last_name`, `salary`, `address_id`, `department_id`, `supervisor_id`, `employee_photo`, `birthday`, `description`, `request_status_id`) VALUES (9, 'Michael', 'Scott', 120000, 9, 10, NULL, 'https://roost.nbcuni.com/bin/viewasset.html/content/dam/Peacock/Landing-Pages/2-0-design/the-office/cast-the-office-michael-scott.jpg/_jcr_content/renditions/original.JPEG?downsize=1200:*&output-quality=70', '1972-07-06', NULL, 1);
INSERT INTO `employee` (`id`, `first_name`, `last_name`, `salary`, `address_id`, `department_id`, `supervisor_id`, `employee_photo`, `birthday`, `description`, `request_status_id`) VALUES (10, 'Dwight', 'Schrute', NULL, 10, NULL, NULL, NULL, '1986-01-14', NULL, 1);
INSERT INTO `employee` (`id`, `first_name`, `last_name`, `salary`, `address_id`, `department_id`, `supervisor_id`, `employee_photo`, `birthday`, `description`, `request_status_id`) VALUES (11, NULL, NULL, NULL, 11, NULL, NULL, NULL, '1980-11-14', NULL, 1);
INSERT INTO `employee` (`id`, `first_name`, `last_name`, `salary`, `address_id`, `department_id`, `supervisor_id`, `employee_photo`, `birthday`, `description`, `request_status_id`) VALUES (12, NULL, NULL, NULL, 12, NULL, NULL, NULL, '1988-12-24', NULL, 1);
INSERT INTO `employee` (`id`, `first_name`, `last_name`, `salary`, `address_id`, `department_id`, `supervisor_id`, `employee_photo`, `birthday`, `description`, `request_status_id`) VALUES (13, NULL, NULL, NULL, 13, NULL, NULL, NULL, '1995-08-29', NULL, 1);
INSERT INTO `employee` (`id`, `first_name`, `last_name`, `salary`, `address_id`, `department_id`, `supervisor_id`, `employee_photo`, `birthday`, `description`, `request_status_id`) VALUES (14, NULL, NULL, NULL, 14, NULL, NULL, NULL, '1981-03-29', NULL, 1);
INSERT INTO `employee` (`id`, `first_name`, `last_name`, `salary`, `address_id`, `department_id`, `supervisor_id`, `employee_photo`, `birthday`, `description`, `request_status_id`) VALUES (15, NULL, NULL, NULL, 15, NULL, NULL, NULL, '1976-01-23', NULL, 1);
INSERT INTO `employee` (`id`, `first_name`, `last_name`, `salary`, `address_id`, `department_id`, `supervisor_id`, `employee_photo`, `birthday`, `description`, `request_status_id`) VALUES (16, NULL, NULL, NULL, 16, NULL, NULL, NULL, '1979-11-08', NULL, 1);
INSERT INTO `employee` (`id`, `first_name`, `last_name`, `salary`, `address_id`, `department_id`, `supervisor_id`, `employee_photo`, `birthday`, `description`, `request_status_id`) VALUES (17, NULL, NULL, NULL, 17, NULL, NULL, NULL, '1958-12-24', NULL, 1);
INSERT INTO `employee` (`id`, `first_name`, `last_name`, `salary`, `address_id`, `department_id`, `supervisor_id`, `employee_photo`, `birthday`, `description`, `request_status_id`) VALUES (18, NULL, NULL, NULL, 18, NULL, NULL, NULL, '1983-06-28', NULL, 1);
